...
- **The EB origin's CNAME is not stable** across environment recreations — see `deploy/README.md` if the dev environment has been terminated and recreated; the CloudFront origin domain needs manually updating to match.
